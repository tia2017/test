            ...
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    @if(Session::get('role') == 2)
                        <div class="nav-item has-sub">
                            <a href="javascript:void(0)"><i class="ik ik-user"></i><span>Pengguna</span></a>
                            <div class="submenu-content">
                                <a href="/users" class="menu-item">Data Pengguna</a>
                                <a href="/users/tambah" class="menu-item">Tambah Pengguna</a>
                            </div>
                        </div>
                        ...
                        <div class="nav-item has-sub">
                            ...
                            <div class="submenu-content">
                                ...
                                <a href="/roles/tambah" class="menu-item">Data Tipe</a>
                            </div>
                        </div>
                    @endif
